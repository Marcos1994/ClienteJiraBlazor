		...
		public TarefaProfile()
		{
			CreateMap<ClienteJiraAPI.Modelos.Entrada.ItemTarefa, Negocio.Modelos.Entidades.Tarefa>()
				...
				.ForMember(d => d.DataInicio, opt =>
					{
						opt.PreCondition(o => o.fields.customfield_12505 != null);
				...
				.ForMember(d => d.Epico, opt => opt.MapFrom(o =>
					(o.fields.parent != null && o.fields.parent.fields.issueType.id == "5") ? o.fields.parent : null))
				...
				.ForMember(d => d.Sprint, opt => opt.MapFrom(o =>
					(o.fields.customfield_10300 != null && o.fields.customfield_10300.Count > 1)
					? o.fields.customfield_10300.First() : null))
