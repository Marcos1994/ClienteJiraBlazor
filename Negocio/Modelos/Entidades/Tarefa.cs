...
namespace Negocio.Modelos.Entidades
{
	public class Tarefa : Item
	{
		...
		public Tarefa(int id, string chave, string nome, EnumStatus status, Usuario reportado, Usuario atribuido, DateTime dataInicio, DateTime dataLimite, string descricao, Projeto projeto, Epico epico, Etapa etapa, int myProperty, EnumTarefa tipoTarefa, Sprint sprint)
